# Create comprehensive CSS styles for the AI Galaxy application
css_content = '''/* AI Galaxy - Global Styles */
...
:root {
  ...
  --gradient-galaxy: linear-gradient(135deg, #1e3c72 0%, #2a5298 100%);
...
print("File created:")
print("  - src/styles/globals.css")
print(f"\n📊 CSS Stats:")
print(f"  - Lines of code: {len(css_content.splitlines())}")
